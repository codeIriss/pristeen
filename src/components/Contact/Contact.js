    ...
    return (
        <section className="py-3" >
             ...
             <div className="col-10 col-sm-8 mx-auto">
                 <form action="https://formspree.io/adityatwist247@gmail.com" method="POST">
                     ...
                     <div className="form-group">
                         <input type="text" name="moblie" id="mobile" placeholder="Your Number" className="form-control
                         "/>
